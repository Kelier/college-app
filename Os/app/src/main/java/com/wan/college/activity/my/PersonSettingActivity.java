...
private TextView me_cache;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        me_cache= (TextView) findViewById(R.id.me_cache);
        try {
            cache_origin=getTotalCacheSize(getApplicationContext());
            me_cache.setText(cache_origin);
        } catch (Exception e) {
            e.printStackTrace();
