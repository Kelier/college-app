...
public class SmartScrollView extends NestedScrollView {
    ...
    private boolean isMovedToTop = false;
    private boolean isMovedToBottom = false;
    private boolean onMoving = true;
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (android.os.Build.VERSION.SDK_INT < 9) {  // API 9及之后走onOverScrolled方法监听
            ...
            if(isMovedToBottom&&!onMoving)notifyScrollChangedListeners();
    ...
    public boolean isMovedToBottom() {
        return isMovedToBottom;
    }
}
